...
const EDITOR_FONT_SIZES = ["12px", "13px", "14px", "16px", "18px", "20px","23px","30px"];
			...
			<div aria-modal='true' role='dialog' className='fixed inset-0 overflow-y-auto z-modal'>
				<div className='flex min-h-screen items-center justify-center px-4'>
					...
					<div
						...
						onClick={() => setSettings({ ...settings, settingsModalOpen: false, dropdownOpen:false })}
					>
						...
						<div className='flex items-center border-b px-5 py-4 text-lg font-medium  border-dark-divider-border-2'>
							...
							<button
								...
								onClick={() => {
                                    ...
                                    setSettings({ ...settings, settingsModalOpen: false, dropdownOpen:false  })
                                    console.log(settings);
                                }}
							>
								<IoClose />
